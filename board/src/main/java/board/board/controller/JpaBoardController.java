...
public class JpaBoardController {
	...
	//신규 게시물 등록 화면 실행
	@ApiOperation(value = "신규 게시물 등록 화면 실행")
	...
	@ApiOperation(value = "게시판 등록화면에서 등록버튼 클릭 처리")
	...
	//특정 게시물 상세보기
	@ApiOperation(value = "특정 게시물 상세보기")
	@RequestMapping(value="/jpa/board/{boardIdx}",
			        method=RequestMethod.GET)
	public ModelAndView openBoardDetail(@PathVariable("boardIdx") @ApiParam(value="게시글 번호") int boardIdx) throws Exception {
	...
	//특정 게시물 삭제처리
	@ApiOperation(value = "특정 게시물 삭제처리")
	@RequestMapping(value="/jpa/board/{boardIdx}",
	...
	//첨부파일 다운로드 처리
	@ApiOperation(value = "첨부파일 다운로드 처리")
